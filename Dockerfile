...
# COPY --from=libdeflate-builder libdeflate/gunzip /usr/local/bin/libdeflate-gunzip
# COPY --from=libdeflate-builder libdeflate/gzip /usr/local/bin/libdeflate-gzip
